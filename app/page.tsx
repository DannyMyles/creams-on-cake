...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-cake-roseLight via-cake-primary to-cake-roseLight relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-pattern-dots opacity-20"></div>
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-white/30 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-white/30 rounded-full blur-3xl"></div>
        </div>

        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-6">
            Ready to Order <span className="text-gradient-primary">Your Dream Cake?</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/contact"
                className="btn-primary text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-900 transition-all duration-300 hover:scale-105 shadow-cake-lg"
              >
                Get a In Touch
              </Link>
              <Link 
                href="/gallery"
                className="border-2 border-[#E0ACB0] text-gray-600 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-[#E0ACB0] hover:text-white transition-all duration-300"
              >
                View Gallery
              </Link>
            </div>
