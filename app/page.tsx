...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="py-20 bg-gradient-to-br from-cake-dark via-cake-darkLight to-cake-dark relative overflow-hidden">
        {/* Background Pattern */}
            ...
            <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl p-8 md:p-12">
              ...
              <div className="text-center">
                <div className="flex justify-center mb-6">
                  <Quote size={48} className="text-cake-primary/50" />
                </div>
                ...
                <div className="flex items-center justify-center gap-6">
                  <img
                    ...
                    className="w-16 h-16 rounded-full object-cover border-2 border-cake-primary"
                  />
                  ...
                  <div className="ml-4 bg-gradient-to-br from-cake-primary to-cake-accent px-4 py-2 rounded-xl font-bold text-sm">
